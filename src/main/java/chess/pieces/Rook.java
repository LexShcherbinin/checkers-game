...
public class Rook implements IPieces {
  ...
  public List<Consumer<IPieces>> getActions() {
    ...
    Consumer<IPieces> downAndRight = piece -> new Rook(piece).setCoordinates(new Coordinates(vertical - 1, horizontal + 1));
    Consumer<IPieces> downAndLeft = piece -> new Rook(piece).setCoordinates(new Coordinates(vertical - 1, horizontal - 1));
