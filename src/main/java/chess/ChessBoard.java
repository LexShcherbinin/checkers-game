...
//   */
//  private IPieces getPrices(List<IPieces> priceList, Colors priority) {
//    Random random = new Random();
//
//    // Получить список всех фигур, которыми можно пойти
//    List<IPieces> pieceList = priceList
//        .stream()
...
//   */
//  private Function<IPieces, IPieces> getAction(IPieces piece) {
//    Random random = new Random();
//
